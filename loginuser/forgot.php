...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'kirim_kode') {
        ...
        if ($username === '') {
            ...
            $stmt = mysqli_prepare(
                $conn,
                "SELECT username, nomor FROM usertb WHERE username = ? LIMIT 1"
            );
            ...
            if (!$stmt) {
                ...
                if ($user) {
                    ...
                    $pesan = "Kode reset password kamu: {$kode}\n\nKode ini berlaku 5 menit.";
    ...
    if ($action === 'reset_password') {
        if (
            ...
            if (strlen($password_baru) < 8) {
                ...
                $stmt = mysqli_prepare(
                    $conn,
                    "UPDATE usertb SET password = ? WHERE username = ? LIMIT 1"
                );
                ...
                if (!$stmt) {
                    ...
                    if ($ok) {
                        ...
                        $success = 'Password berhasil diubah. Kamu akan diarahkan ke halaman login.';
    ...
    <div class="wrap">
        <section class="brand">
            <div class="brand-top">
                ...
                <div>
                    <h1>Lupa Password</h1>
                    <p>
                        Reset password dengan verifikasi WhatsApp. Setelah kode OTP benar,
                        kamu bisa langsung bikin password baru dan login lagi.
                    </p>
                </div>
            </div>
            ...
            <div class="steps">
                <div class="step-item">
                    ...
                    <div>
                        ...
                        <span>Sistem akan mencari akun kamu di database usertb.</span>
                    </div>
                </div>
                <div class="step-item">
                ...
                <div class="step-item">
                    ...
                    <div>
                        ...
                        <span>Password langsung di-hash dan disimpan aman.</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="panel">
            ...
            <div class="small-note">
                Pastikan kolom database yang dipakai adalah <b>username</b>, <b>password</b>, <b>nomor</b>, dan <b>keranjang</b>.
                Password baru disimpan menggunakan <code>password_hash()</code>.
            </div>
        </section>
    </div>
</body>
